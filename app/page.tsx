...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-bold text-center mb-12">Featured Trade Careers</h3>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="border-2 border-yellow-400 rounded-xl p-6">
              <div className="text-4xl mb-4">⚡</div>
              <h4 className="text-xl font-semibold mb-2">Electrician</h4>
              <ul className="space-y-2 text-gray-600 mb-4">
                <li>✓ $60K-$90K starting</li>
                <li>✓ 4-5 year apprenticeship</li>
                <li>✓ Signing bonuses common</li>
                <li>✓ High job security</li>
              </ul>
              <a href="/assessment" className="block text-center bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition">
                Learn More
              </a>
            </div>
            ...
            <div className="border-2 border-blue-400 rounded-xl p-6">
              <div className="text-4xl mb-4">🔧</div>
              <h4 className="text-xl font-semibold mb-2">Plumber</h4>
              <ul className="space-y-2 text-gray-600 mb-4">
                <li>✓ $55K-$85K starting</li>
                <li>✓ 4-5 year apprenticeship</li>
                <li>✓ 6-figure mid-career</li>
            ...
            <div className="border-2 border-green-400 rounded-xl p-6">
              <div className="text-4xl mb-4">❄️</div>
              <h4 className="text-xl font-semibold mb-2">HVAC Tech</h4>
              <ul className="space-y-2 text-gray-600 mb-4">
                <li>✓ $50K-$80K starting</li>
                <li>✓ 6-24 month training</li>
                <li>✓ Very high demand</li>
